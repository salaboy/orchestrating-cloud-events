...
- [Zeebe Modeler](https://github.com/zeebe-io/zeebe-modeler/releases) to edit your workflow models
...
# Architecture
After thinking for a while, one of the possible solutions might be to use an **Event-Driven** Approach to architect the services behind the application. 
...
As you can see these events repesent a single sale of tickets, in other words, the events that will be emitted by a Customer going through the entire process of buying tickets for a particular concert. 
